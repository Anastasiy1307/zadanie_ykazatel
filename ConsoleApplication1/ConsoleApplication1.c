...
int main()
{
	...
	do
	{
		...
		printf("2. Динамическое создание и удаление массива из одного миллиона элементов типа int. значения элементов массива должны\nбыть равны значению их индексов\n");
		...
		case 5:
			...
			printf("%d", Pointers_funkc(Kva, 40));
			break;
